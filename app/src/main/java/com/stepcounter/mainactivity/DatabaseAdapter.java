...
public class DatabaseAdapter {
	 ...
	 */
	public static final String PROFILES_TABLE_KEY_DIST_TOT_KM = "tot_dist_km";
	/**
	 * Profiles table field: steps_tot.
	 */
	public static final String PROFILES_TABLE_KEY_STEPS_TOT = "tot_steps";
	/**
	 * Profiles table field: time_tot_sec.
	 */
	public static final String PROFILES_TABLE_KEY_TIME_TOT_SEC = "tot_time_sec";
	/**
	 * Profiles table field: kcal_tot.
	 */
	public static final String PROFILES_TABLE_KEY_KCAL_TOT = "tot_kcal";
	/**
	 ...
	 * Profiles table field: x.
	 */
	public static final String PROFILES_TABLE_KEY_AVATAR_PATH = "avatar_path";
	...
	private ContentValues createContentValuesProfilesTable(
			...
			int height, int weight, int stepLen, 
			int distTotKm, int stepsTot, int timeTotSec,
			int kcalTot, int x, String avatarPath) {
		...
		values.put( PROFILES_TABLE_KEY_AVATAR_PATH, avatarPath );
	...
	public long createNewProfile(
		...
		ContentValues initialValues = createContentValuesProfilesTable(name, surname, gender, height, weight, stepLen, distTotKm,stepsTot,timeTotSec,kcalTot,x, avatarPath);
	...
	public boolean updateProfile(long id,
			...
			int distTotKm, int stepsTot, int timeTotSec,
			int kcalTot, int x, String avatarPath) {
		ContentValues updateValues = createContentValuesProfilesTable(name, surname, gender, height, weight, stepLen, distTotKm,stepsTot,timeTotSec,kcalTot,x, avatarPath);
		return database.update(PROFILES_TABLE, updateValues, PROFILES_TABLE_KEY_PROFILEID + "=" + id, null) > 0;
	}
	...
	public Cursor fetchAllProfiles() {
		return database.query(PROFILES_TABLE, new String[] { PROFILES_TABLE_KEY_PROFILEID, PROFILES_TABLE_KEY_NAME, PROFILES_TABLE_KEY_SURNAME, 
															...
															PROFILES_TABLE_KEY_TIME_TOT_SEC, PROFILES_TABLE_KEY_KCAL_TOT, PROFILES_TABLE_KEY_X, PROFILES_TABLE_KEY_AVATAR_PATH}, null, null, null, null,null);
	}
	...
	public Cursor fetchProfilesByFilter(String filter) {
		Cursor mCursor = database.query(true, PROFILES_TABLE, new String[]{ PROFILES_TABLE_KEY_PROFILEID, PROFILES_TABLE_KEY_NAME, PROFILES_TABLE_KEY_SURNAME, 
															PROFILES_TABLE_KEY_GENDER, PROFILES_TABLE_KEY_HEIGHT, PROFILES_TABLE_KEY_WEIGHT, 
															PROFILES_TABLE_KEY_STEP_LEN, PROFILES_TABLE_KEY_DIST_TOT_KM, PROFILES_TABLE_KEY_STEPS_TOT, 
															PROFILES_TABLE_KEY_TIME_TOT_SEC, PROFILES_TABLE_KEY_KCAL_TOT, PROFILES_TABLE_KEY_X, PROFILES_TABLE_KEY_AVATAR_PATH},
